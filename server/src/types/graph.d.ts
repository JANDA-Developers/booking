...
export interface GetHousesForSuperUserQueryArgs {
  first: number;
  cursor: string | null;
...
export interface GetHousesForSuperUserResponse {
  ok: boolean;
  error: string | null;
  result: GetHousesForSuperUserResponseCursor | null;
}

export interface GetHousesForSuperUserResponseCursor {
