...
export interface Query {
  ...
  GetallocatedBedList: GetallocatedBedListResponse;
...
export interface GetallocatedBedListQueryArgs {
  houseId: string;
  start: DateTime;
  end: DateTime;
}
...
export interface GetallocatedBedListResponse {
  ok: boolean;
  error: string | null;
  allocatedBedList: Array<allocatedBed>;
}

export interface allocatedBed {
  room: Room;
  date: DateTime;
  guests: Array<Guest>;
}
