...
var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.findInternal = function (l, x, n) {
    l instanceof String && (l = String(l));
    for (var q = l.length, v = 0; v < q; v++) {
        var u = l[v];
        if (x.call(n, u, v, l)) return {
            i: v,
            v: u
        }
    }
...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function (l, x, n) {
    l != Array.prototype && l != Object.prototype && (l[x] = n.value)
};
$jscomp.getGlobal = function (l) {
    return "undefined" != typeof window && window === l ? l : "undefined" != typeof global && null != global ? global : l
};
$jscomp.global = $jscomp.getGlobal(this);
$jscomp.polyfill = function (l, x, n, q) {
    if (x) {
        n = $jscomp.global;
        l = l.split(".");
        ...
        q = n[l];
        x = x(q);
        x != q && null != x && $jscomp.defineProperty(n, l, {
            configurable: !0,
            writable: !0,
            value: x
        })
...
$jscomp.polyfill("Array.prototype.find", function (l) {
    return l ? l : function (l, n) {
        return $jscomp.findInternal(this, l, n).v
    }
}, "es6", "es3");
(function (l) {
    function x(f) {
        ...
        if (b || "json-stringify" == f || "json-parse" == f) {
            if ("json-stringify" == f || b) {
                var d = z.stringify,
                    k = "function" == typeof d && B;
                if (k) {
                    (a = function () {
                        return 1
                    }).toJSON = a;
                    try {
                        k = "0" === d(0) && "0" === d(new Number) && '""' == d(new String) && d(n) === v && d(v) === v && d() === v && "1" === d(a) && "[1]" == d([a]) && "[null]" == d([v]) && "null" == d(null) && "[null,null,null]" == d([v, n, null]) && '{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}' == d({
                                a: [a, !0, !1, null, "\x00\b\n\f\r\t"]
                            }) &&
    ...
    var n = {}.toString,
        q, v, u = "function" === typeof define && define.amd,
        z = "object" == typeof exports && exports;
    z || u ? "object" == typeof JSON && JSON ? z ? (z.stringify = JSON.stringify, z.parse = JSON.parse) : z = JSON : u && (z = l.JSON = {}) : z = l.JSON || (l.JSON = {});
    ...
    if (!x("json")) {
        ...
        if (!B) var C = Math.floor,
            ...
            D = function (f, a) {
                return I[a] + 365 * (f - 1970) + C((f - 1969 + (a = +(1 < a))) / 4) - C((f - 1901 + a) / 100) + C((f - 1601 + a) / 400)
            };
        (q = {}.hasOwnProperty) || (q = function (a) {
            var f = {};
            if ((f.__proto__ = null, f.__proto__ = {
                    toString: 1
                }, f).toString != n) q = function (f) {
                var a = this.__proto__;
                f = f in (this.__proto__ = null, this);
                this.__proto__ = a;
                return f
            };
            else {
                var d = f.constructor;
                q = function (f) {
                    var a = (this.constructor || d).prototype;
                    return f in this && !(f in
                        a && this[f] === a[f])
                }
            }
            f = null;
        ...
        var c = function (f, a) {
            ...
            var g = new b;
            for (k in g) q.call(g, k) && d++;
            b = g = null;
            d ? d = 2 == d ? function (f, a) {
                var d = {},
                    b = "[object Function]" == n.call(f),
                    h;
                for (h in f) b && "prototype" == h || q.call(d, h) || !(d[h] = 1) || !q.call(f, h) || a(h)
            } : function (f, a) {
                var d = "[object Function]" == n.call(f),
                    b, h;
                for (b in f) d && "prototype" == b || !q.call(f, b) || (h = "constructor" === b) || a(b);
                (h || q.call(f, b = "constructor")) && a(b)
            } : (g = "valueOf toString toLocaleString propertyIsEnumerable isPrototypeOf hasOwnProperty constructor".split(" "), d = function (f, a) {
                var d = "[object Function]" == n.call(f),
                    b, k;
                if (k = !d && "function" != typeof f.constructor) k = typeof f.hasOwnProperty, k = "object" == k ? !!f.hasOwnProperty : !e[k];
                k = k ? f.hasOwnProperty : q;
                for (b in f) d && "prototype" == b || !k.call(f, b) || a(b);
                for (d = g.length; b = g[--d]; k.call(f, b) && a(b));
            });
            return d(f, a)
        };
        if (!x("json-stringify")) {
                    ...
                    for (e && (g = f.split("")); d < k; d++) {
                        ...
                        switch (h) {
                            ...
                            case 92:
                                ...
                                break;
                            default:
                                a = 32 > h ? a + ("\\u00" + y(2, h.toString(16))) : a + (e ? g[d] : F ? f.charAt(d) : f[d])
                        }
                    }
                    return a + '"'
                },
                p = function (f, a, d, b, k, e, h) {
                    var g = a[f],
                        w, E;
                    try {
                        g = a[f]
                    ...
                    if ("object" == typeof g && g) {
                        var m = n.call(g);
                        if ("[object Date]" != m || q.call(g, "toJSON")) "function" ==
                            typeof g.toJSON && ("[object Number]" != m && "[object String]" != m && "[object Array]" != m || q.call(g, "toJSON")) && (g = g.toJSON(f));
                        else if (g > -1 / 0 && g < 1 / 0) {
                            if (D) {
                                var r = C(g / 864E5);
                                for (m = C(r / 365.2425) + 1970 - 1; D(m + 1, 0) <= r; m++);
                                for (w = C((r - D(m, 0)) / 30.42); D(m, w + 1) <= r; w++);
                                r = 1 + r - D(m, w);
                                var G = (g % 864E5 + 864E5) % 864E5;
                                var l = C(G / 36E5) % 24;
                                var K = C(G / 6E4) % 60;
                                var A = C(G / 1E3) % 60;
                                G %= 1E3
                            } else m = g.getUTCFullYear(), w = g.getUTCMonth(), r = g.getUTCDate(), l = g.getUTCHours(), K = g.getUTCMinutes(), A = g.getUTCSeconds(), G = g.getUTCMilliseconds();
                            g =
                                (0 >= m || 1E4 <= m ? (0 > m ? "-" : "+") + y(6, 0 > m ? -m : m) : y(4, m)) + "-" + y(2, w + 1) + "-" + y(2, r) + "T" + y(2, l) + ":" + y(2, K) + ":" + y(2, A) + "." + y(3, G) + "Z"
                        } else g = null
                    }
                    d && (g = d.call(a, f, g));
                    ...
                    if ("[object String]" == m) return H("" + g);
                    if ("object" == typeof g) {
                        for (f = h.length; f--;)
                            if (h[f] === g) throw TypeError();
                        h.push(g);
                        var t = [];
                        a = e;
                        e += k;
                        if ("[object Array]" == m) {
                            w = 0;
                            for (f = g.length; w < f; E || (E = !0), w++) m = p(w, g, d, b, k, e,
                                h), t.push(m === v ? "null" : m);
                            f = E ? k ? "[\n" + e + t.join(",\n" + e) + "\n" + a + "]" : "[" + t.join(",") + "]" : "[]"
                        } else c(b || g, function (a) {
                            var f = p(a, g, d, b, k, e, h);
                            f !== v && t.push(H(a) + ":" + (k ? " " : "") + f);
                            E || (E = !0)
                        }), f = E ? k ? "{\n" + e + t.join(",\n" + e) + "\n" + a + "}" : "{" + t.join(",") + "}" : "{}";
                        h.pop();
            ...
            z.stringify = function (a, d, b) {
                if ("function" == typeof d || "object" == typeof d && d)
                    if ("[object Function]" == n.call(d)) var f = d;
                    else if ("[object Array]" == n.call(d)) {
                    var g = {};
                    for (var k = 0, e = d.length, m; k < e; m = d[k++], ("[object String]" == n.call(m) ||
                            "[object Number]" == n.call(m)) && (g[m] = 1));
                }
                if (b)
                    if ("[object Number]" == n.call(b)) {
                        if (0 < (b -= b % 1)) {
                            var c = "";
                            for (10 < b && (b = 10); c.length < b; c += " ");
                        }
                    } else "[object String]" == n.call(b) && (c = 10 >= b.length ? b : b.slice(0, 10));
                return p("", (m = {}, m[""] = a, m), f, g, c, "", [])
            }
        }
        if (!x("json-parse")) {
            var a = String.fromCharCode,
                ...
                r = function () {
                    for (var f = t, b = f.length, g, e, c, r, h; d < b;) switch (h = f.charCodeAt(d), h) {
                        case 9:
                        case 10:
                        case 13:
                        case 32:
                        ...
                        case 58:
                        case 44:
                            return g = F ? f.charAt(d) : f[d], d++, g;
                        case 34:
                            g = "@";
                            for (d++; d < b;)
                                if (h = f.charCodeAt(d), 32 > h) m();
                                ...
                                case 117:
                                    e = ++d;
                                    for (c = d + 4; d < c; d++) h = f.charCodeAt(d), 48 <= h && 57 >= h || 97 <= h && 102 >= h || 65 <= h && 70 >= h || m();
                                    g += a("0x" + f.slice(e, d));
                                    break;
                                default:
                                    m()
                                ...
                                if (34 == h) break;
                                h = f.charCodeAt(d);
                                for (e = d; 32 <= h && 92 != h && 34 != h;) h = f.charCodeAt(++d);
                                g += f.slice(e, d)
                            }
                            if (34 == f.charCodeAt(d)) return d++, g;
                            m();
                        default:
                            e = d;
                            45 == h && (r = !0, h = f.charCodeAt(++d));
                            if (48 <= h && 57 >= h) {
                                for (48 == h && (h = f.charCodeAt(d + 1), 48 <= h && 57 >= h) && m(); d < b && (h = f.charCodeAt(d), 48 <= h && 57 >= h); d++);
                                if (46 == f.charCodeAt(d)) {
                                    for (c = ++d; c < b && (h = f.charCodeAt(c), 48 <= h && 57 >= h); c++);
                                    c == d && m();
                                    d = c
                                }
                                h = f.charCodeAt(d);
                ...
                J = function (a) {
                    ...
                    "$" == a && m();
                    if ("string" == typeof a) {
                        if ("@" == (F ? a.charAt(0) : a[0])) return a.slice(1);
                        if ("[" == a) {
                            for (b = [];; d || (d = !0)) {
                                a = r();
                                if ("]" == a) break;
                        ...
                        if ("{" == a) {
                            for (b = {};; d || (d = !0)) {
                                ...
                                if ("}" == a) break;
                                d && ("," == a ? (a = r(), "}" == a && m()) : m());
                                "," != a && "string" == typeof a && "@" == (F ? a.charAt(0) : a[0]) && ":" == r() || m();
                                b[a.slice(1)] =
                                    J(r())
                            }
                            return b
                ...
                g = function (a, b, d) {
                    var g = a[b],
                        f;
                    if ("object" == typeof g && g)
                        if ("[object Array]" == n.call(g))
                            for (f = g.length; f--;) A(g, f, d);
                        else c(g, function (a) {
                            A(g, a, d)
                        });
                    return d.call(a, b, g)
                };
            z.parse = function (a, b) {
                var f;
                d = 0;
                t = "" + a;
                a = J(r());
                "$" != r() && m();
                d = t = null;
                return b && "[object Function]" == n.call(b) ? g((f = {}, f[""] = a, f), "", b) : a
            }
        }
    }
    u && define(function () {
...
window.IMP || function (l) {
    ...
    var v = function () {
            return {
                injectQuery: function (e, c) {
                    ...
                    b.host;
                    e = [];
                    for (var y in c) c.hasOwnProperty(y) && e.push([y, c[y]].join("="));
                    c = b.search;
                    e = e.join("&");
                    c = c ? -1 < c.lastIndexOf("&") ? c + e : c + ("&" + e) : "?" + e;
                    return b.protocol + "//" + b.host + b.pathname + c + b.hash
                }
            }
        }(),
        u = function () {
            function e() {
                if (!c) {
                    ...
                    var e = navigator.userAgent,
                        p = /(?:MSIE.(\d+\.\d+))|(?:(?:Firefox|GranParadiso|Iceweasel).(\d+\.\d+))|(?:Opera(?:.+Version.|.)(\d+\.\d+))|(?:AppleWebKit.(\d+(?:\.\d+)?))|(?:Trident\/\d+\.\d+.*rv:(\d+\.\d+))/.exec(e),
                        w = /(Mac OS X)|(Windows)|(Linux)/.exec(e);
                    A = /\b(iPhone|iP[ao]d)/.exec(e);
                    g = /\b(iP[ao]d)/.exec(e);
                    r = /Android/i.exec(e);
                    f = /FBAN\/\w+;/i.exec(e);
                    E = /Mobile/i.exec(e);
                    n = !!/Win64/.exec(e);
                    if (p) {
                        (b = p[1] ? parseFloat(p[1]) : p[5] ? parseFloat(p[5]) : NaN) && document && document.documentMode && (b = document.documentMode);
                        var h = /(?:Trident\/(\d+.\d+))/.exec(e);
                        k = h ? parseFloat(h[1]) + 4 : b;
                        y = p[2] ? parseFloat(p[2]) : NaN;
                        H = p[3] ? parseFloat(p[3]) : NaN;
                        a = (l = p[4] ? parseFloat(p[4]) : NaN) ? (p = /(?:Chrome\/(\d+\.\d+))/.exec(e)) && p[1] ? parseFloat(p[1]) :
                            NaN : NaN
                    } else b = y = H = a = l = NaN;
                    w ? (d = w[1] ? (e = /(?:Mac OS X (\d+(?:[._]\d+)?))/.exec(e)) ? parseFloat(e[1].replace("_", ".")) : !0 : !1, t = !!w[2], m = !!w[3]) : d = t = m = !1
                }
            }
            var c = !1,
                b, y, H, l, a, k, d, t, m, r, n, A, g, f, E, w = {
                    ie: function () {
                        return e() || b
                    },
        ...
        z = function () {
            ...
            e.prototype.submit = function (b) {
                ...
                c.name = c.id = "shinhanFormProxy";
                c.action = b.submitUrl;
                for (var p in b.frmData) {
                ...
                c.target = this.targetName;
                c.submit();
                jQuery(e).remove()
            };
            e.prototype.open = function (b, e) {
                if (this.popup = l.open("about:blank", this.targetName, "height=400,width=640,location=no,status=yes,dependent=no,scrollbars=yes,resizable=yes")) {
                    var c = function (a) {
                        if (p.monitoring) return !1 !==
                            a.closed ? (p.frame.communicate({
                                request_id: b,
                                merchant_uid: e,
                                result: "proxy.closed"
        ...
        B = function () {
            ...
            e.prototype.open = function (b, e) {
                u.mobile() || (this.popup = l.open("about:blank", "IMP_NAVER_CHECKOUT"))
            };
            e.prototype.payRedirect =
                function (b) {
                    u.mobile() ? l.location.href = b.payUrl : this.popup.location.href = b.payUrl
                };
            var c = null;
            return {
                init: function (b) {
        ...
        F = function () {
            ...
            e.prototype.open = function (b, e, c, p) {
                if (!p && c)
                    if (this.popup = l.open("about:blank", "IMP_NAVERPAY", "height=900,width=760,location=no,status=yes,dependent=no,scrollbars=yes,resizable=yes")) {
                        var a = function (d) {
                                return !1 !== d.closed ? (k.frame.communicate({
                                    request_id: b,
                                    merchant_uid: e,
                                    imp_uid: k.impUid,
            ...
            e.prototype.openLayer = function (b) {
                function e(b) {
                    ...
                    var a = {
                        ...
                        extraDeduction: b.extraDeduction
                    };
                    b.useCfmYmdt && (a.useCfmYmdt = b.useCfmYmdt);
                    this.npay.open(a)
                }
                var c = this;
                c.npay ? e.call(c, b) : jQuery.getScript("https://nsp.pay.naver.com/sdk/js/naverpay.min.js", function () {
                    c.npay = Naver.Pay.create({
                        mode: b.mode,
                        clientId: b.clientId,
                        openType: b.openType,
                        payType: b.payType,
                        onAuthorize: function (b) {
                            c.frame.communicate({
                                authData: b,
                                return_url: c.npayProxy.returnUrl,
                                request_id: c.npayProxy.requestId,
                                imp_uid: c.npayProxy.impUid,
        ...
        C = function () {
            ...
            e.prototype.open = function (b, e) {
                if (this.popup = l.open("", "IMP_PAYCO", "top=100, left=300, width=727px, height=512px, resizble=no, scrollbars=yes")) {
                    var c =
                        function (a) {
                            return !1 !== a.closed ? (n.frame.communicate({
                                request_id: b,
                                merchant_uid: e,
                                imp_uid: n.impUid,
                                result: "check.closing"
    ...
    x.prototype.submit = function (e) {
        ...
        b.method = "post";
        b.target = "_top";
        for (var l in e.formData) {
            var n = document.createElement("input");
            n.type = "hidden";
            n.name = l;
            n.value = e.formData[l];
            b.appendChild(n)
        }
        c.appendChild(b);
    ...
    var I = function () {
            ...
            e.prototype.submit = function (b) {
                ...
                var e = document.createElement("div"),
                    c = document.createElement("form");
                c.name = c.id = "eximbayFormProxy";
                c.action = b.action;
                c.method = "post";
                for (var l in b.formData) {
                    var a = document.createElement("input");
                    a.type = "hidden";
                    a.name = l;
                    a.value = b.formData[l];
                    c.appendChild(a)
                }
                e.appendChild(c);
                this.frame.dialog.append(e);
            ...
            e.prototype.open =
                function (b, e) {
                    if (this.popup = l.open("about:blank", this.targetName, "height=400,width=640,location=no,status=yes,dependent=no,scrollbars=yes,resizable=yes")) {
                        var c = function (a) {
                            if (n.monitoring) return !1 !== a.closed ? (n.frame.communicate({
                                request_id: b,
                                merchant_uid: e,
                                imp_uid: n.impUid,
                                result: "proxy.closed"
        ...
        D = function (e) {
                ...
                p = function () {
                    function a() {
                        function a(a) {
                            ...
                            try {
                                f = JSON.parse(a.data), c = f.action, g = f.data || {}, r = g.request_id
                            } catch (h) {}
                            if ("kakao.dlp" === c) {
                                var p = g;
                                g = p.scripts;
                                ...
                                a = 0;
                                for (f = A.length; a < f; a++) k(A[a]);
                                A = jQuery.Deferred().resolve();
                                a = 0;
                                for (f = g.length; a < f; a++) A = A.then(c(g[a]));
                                A.then(function () {
                                    var a = b.createDocumentFragment(),
                                        c = b.createElement("form"),
                                        e = b.createElement("div");
                                    c.acceptCharset = "UTF-8";
                                    c.name = c.id = "kakaoPayFormProxy";
                                    e.id = "kakaopay_layer";
                                    for (var g in p.formData) {
                                        var f = b.createElement("input");
                                        f.type = "hidden";
                                        f.name = g;
                                        f.value = p.formData[g];
                                        c.appendChild(f)
                                    }
                                    a.appendChild(c);
                                    a.appendChild(e);
                            ...
                            } else if ("inicis.mobile" == c)(new x(t)).submit(g);
                            else if ("payco.modal" === c) C.instance().payRedirect(g);
                            else if ("shinhan.modal" === c) a = z.instance(), a.submit(g);
                            else {
                                if ("done" === c && "shinhan" ==
                                    g.pg_provider) a = z.instance(), a.close();
                                else {
                                    if ("naverco.modal" === c) {
                                        B.instance().payRedirect(g);
                                        t.close();
                                        return
                                    }
                                    if ("naverpay.modal" === c) {
                                    ...
                                    if ("done" === c && "eximbay" == g.pg_provider) a = I.instance(), a.close();
                                    else if ("proxy.post" === c) {
                                        l(t, g);
                                        return
                                    }
                                }
                                ...
                                for (a = f - 1; 0 <= a; a--)
                                    if (n[a].request_id ===
                                        r) try {
                                        delete g.request_id, n[a].callback.call({}, g)
                                    } catch (h) {
                                        e.console && "function" === typeof console.log && console.log(h)
                                    } finally {
                                        n.splice(a, 1);
                                        break
                                    }
                        ...
                        var m = jQuery('<div class="imp-dialog customizable"></div>');
                        jQuery(b.body).append(m);
                        var t = new c(m);
                        e.addEventListener ? e.addEventListener("message", a, !1) : e.attachEvent && e.attachEvent("onmessage", a);
                        return t
                    }
            ...
            c.prototype.create = function (a, b) {
                ...
                k.addClass(function (a) {
                    var b = ["imp-frame"];
                    u.mobile() ? b.push("imp-frame-mobile") : b.push("imp-frame-pc");
                    a.is_default && b.push("imp-frame-default");
                    a.provider &&
                        ("payment" == a.type ? b.push("imp-frame-" + a.provider) : b.push("imp-frame-" + a.provider + "-certification"));
                    return b
                }(a).join(" "));
                this.frames[c] = {
                    iframe: k[0],
                ...
                k.bind("load", function () {
                    ...
                    if (u.mobile()) {
                        var a = function () {
                            ...
                            e.dialog.height() < k.height() && (e.dialog.css({
                                "overflow-y": "scroll",
                                "-webkit-overflow-scrolling": "touch"
                            }).attr("data-height-sync",
                                "yes"), k.css("min-height", k.height()));
                            setTimeout(a, 200)
                        };
                        a()
                    }
            ...
            c.prototype.find = function (a, b) {
                ...
                if (a) {
                    var k =
                        a.indexOf(".");
                    0 < k && (c = a.substring(0, k), e = a.substring(k + 1))
                }
            ...
            c.prototype._key = function (a, b, d) {
                return a ? b ? a + "." + b + "." + d : a : "default"
            };
            c.prototype.path = function (a) {
                var b = "https://service.iamport.kr" + ("certification" === a.type ? "/certificates/ready/" :
                    "/payments/ready/") + this.user_code;
            ...
            c.prototype.open = function (a) {
                var c = u.mobile() ? "mobile" : "pc";
                this.dialog.show();
                this.dialog.removeClass().addClass("imp-dialog customizable").addClass(a.type + "-" + a.provider).addClass(c);
                u.mobile() && (jQuery(b.body).addClass("imp-payment-progress"),
                    (u.iphone() || u.ipad()) && this.dialog.addClass("ios"), this.dialog.css({
                        "overflow-y": "",
            ...
            c.prototype.communicate = function (a) {
                for (var b in this.frames) {
                    ...
                    if (d.is(":visible")) {
                        ...
                        8 == u.ie() || u.ieCompatibilityMode() ? function (a) {
                            setTimeout(function () {
                                a[0].contentWindow.postMessage(c, "https://service.iamport.kr")
                            }, 0)
                        }(d) : d[0].contentWindow.postMessage(c, "https://service.iamport.kr")
                    }
                }
            };
            ...
            return {
                init: function (a) {
                    jQuery(b).ready(function (b) {
                        ...
                        d.setting(a);
                        d.load(function (a) {
                            l && d.find(l.data.pg, l.action).key == a && this.request(l.action, l.data, l.callback)
                        })
                    })
                },
                request: function (a, c, d) {
                    jQuery(b).ready(function (b) {
                        try {
                            ...
                            u.mobile() && "function" != typeof d && (d = defaultCallback = function (a) {
                            ...
                            if (!e.initialized()) return l = {
                                action: a,
                                data: c,
                                callback: d
                            };
                            var k = e.find(c.pg, a);
                            if ("certification" !== a || a ===
                                k.type)
                                if (k.loaded) {
                                    l = null;
                                    e.focus(k);
                                    ...
                                    "payco" !== k.provider || u.mobile() ? "shinhan" != k.provider || u.mobile() ? "kcp" == k.provider && u.mobile() ? self.name = "tar_opener" : "naverco" == k.provider ? B.init(e).open(c.request_id, c.merchant_uid) : "naverpay" == k.provider ? (8 == u.ie() && (c.naverV2 = !1), F.init(e).open(c.request_id, c.merchant_uid, c.naverPopupMode, c.naverV2)) : "paypal" == k.provider ? c.popup = !1 : "eximbay" == k.provider && I.init(e).open(c.request_id, c.merchant_uid) : z.init(e).open(c.request_id, c.merchant_uid) : C.init(e).open(c.request_id, c.merchant_uid);
                                    ...
                                    8 == u.ie() || u.ieCompatibilityMode() ? setTimeout(function () {
                                        k.iframe.contentWindow.postMessage(t, "https://service.iamport.kr")
                                    }, 0) : k.iframe.contentWindow.postMessage(t,
    ...
    n.request_pay = function (e, c) {
        if ("undefined" == typeof e) return alert("\uacb0\uc81c\uc694\uccad \ud30c\ub77c\uba54\ud130\uac00 \ub204\ub77d\ub418\uc5c8\uc2b5\ub2c8\ub2e4."), !1;
        D.request("payment", e, c)
    };
    n.communicate = function (e) {
        D.communicate(e)
    };
    n.certification = function (e, c) {
        if ("undefined" == typeof e) return alert("\uacb0\uc81c\uc694\uccad \ud30c\ub77c\uba54\ud130\uac00 \ub204\ub77d\ub418\uc5c8\uc2b5\ub2c8\ub2e4."),
            !1;
        D.request("certification", e, c)
    }
}.call({}, window);