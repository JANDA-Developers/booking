...
export const CREATE_BILLKEY = gql`
    mutation createBillkey($billParams: CreateBillkeyInput!, $paymentParams: RequestPaymentInput) {
        CreateBillkey(billParams:$billParams, paymentParams:$paymentParams) {
            ok
            error
            billInfo {
                ...FbillInfo
