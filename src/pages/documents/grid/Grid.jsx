  ...
  <div className="container PageGrid">
    <div className="docs-section">
      ...
      <div className="docs-section__box">
        ...
        <p>
          ● Flex-grid 는 display:gird 기반으로 설계되어 기본 space-bwtwwen
          정렬을 합니다.
        </p>
      </div>
      ...
      <div className="docs-section__box">
        ...
        <p>
          ● 수정자 --around 를 사용하여 그사이 space-around 속성을 줄수
          있습니다.
        </p>
      </div>
      ...
      <div className="docs-section__box">
        ...
        <p>
          ● 가장 일반적으로 사용되어야 할 그리드 이며 아주 높은 확장성을
          가집니다.
        </p>
      </div>
      ...
      <div className="docs-section__box">
        ...
        <p>
          ● Flex-Grid-Grow는 기본적으로 남는 여백을 매우려 하고 공간을 나눠
          가지려 합니다.
        </p>
      </div>
