...
const SignUp: React.FC<Iprops> = ({ context }) => {
	...
	const validate = () => {
		...
		if (passwordHook.value !== checkPasswordHook.value) {
			toast.warn(LANG('password_rewrite_error'));
			return false;
		}
		if (passwordHook.value !== checkPasswordHook.value) {
				...
				<form onSubmit={signUpSubmit}>
					...
					<div className="flex-grid docs-section__box">
						<div className="flex-grid__col col--full-12 col--md-12">
							<InputText id="signupName" {...nameHook} validation={utils.isName} label={LANG('name')} />
						</div>
						<div className="flex-grid__col col--full-12 col--md-12">
							<div>
								<InputText
						...
						<div className="flex-grid__col col--full-12 col--md-12">
							<InputText id="signupEamil" {...emailHook} validation={utils.isEmail} label={LANG('eamil')} />
						</div>
						<div className="flex-grid__col col--full-12 col--md-12">
							<InputText
					...
					<div>
						<Button id="signupBtn" thema="primary" type="submit" label={LANG('signup_submit')} />
					</div>
				</form>
			</div>
		</div>
