...
export const OptionalProductModal: React.FC<IProp> = ({
  modalHook,
  ...props
}) => {
  ...
  return (
    ...
    >
      ...
      {/* list */}
      {isEmpty(data) && (
        <JDtypho mb="normal" size="h6" color="grey2">
          추가된 상품이 없습니다.
        </JDtypho>
      )}
      {isEmpty(data) || (
        <div className="optionalProductModal__options">
          {data.map(d => (
            <JDalign
            ...
            >
              <JDtypho mb="no" mr="largest" weight={600}>
                {d.label}
              </JDtypho>
