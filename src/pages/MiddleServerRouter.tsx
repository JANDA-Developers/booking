...
const JDmiddleServer: React.FC<IProps> = ({
  ...
  const {userRole} = user;
  const [sideNavIsOpen, setSideNavIsOpen] = useToggle(true);
                    ...
                    {currentHouse && (
                      <Fragment>
                        ...
                        <Route
                          ...
                          path="/myPage"
                          render={prop => (
                            <MyPage context={contextWithRotuer} />
                          )}
                        />
                        {/* 숙소생성 */}
                        <Route
                        ...
                        <Route
                          ...
                          path="/HMconfig"
                          render={() => (
                            <HMconfig context={contextWithRotuer} />
                          )}
                        />
                        {/* 자세한 가격설정 */}
                        <Route
                          ...
                          path="/dailyPrice"
                          render={() => (
                            <DailyPrice context={contextWithRotuer} />
                          )}
                        />
                        {/* 통계 */}
                        <Route
                          ...
                          path="/statistic"
                          render={() => (
                            <Statistic context={contextWithRotuer} />
                          )}
                        />
                        {/* 방생성 */}
                        <Route
                        ...
                        <Route
                          ...
                          path="/setPrice"
                          render={() => (
                            <SetPrice context={contextWithRotuer} />
                          )}
                        />
                        {/* 예약목록 */}
                        <Route
                          ...
                          path="/resvList"
                          render={() => (
                            <ResvList context={contextWithRotuer} />
                          )}
                        />
                      </Fragment>
                    )}
