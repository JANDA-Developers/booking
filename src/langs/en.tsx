...
export const en = {
  ...
  HM_set__desc: (
    <span>
      The AI Auto Solution provides a guide page for guests to use the accommodation
      easily and conveniently. Send. <br />
      The AI Auto Solution will save you the trouble of explaining how to use your
      accommodation.
    </span>
  ),
  user_info: "Profile",
    ...
    <JDlist
      ...
      contents={[
        ...
        <div>
          ...
          <b>
            Accommodation Date / Accommodation Information / Reservation Name / Price
            / Payment Method / Payment Status / AI Auto URL
          </b>
