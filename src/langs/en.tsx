...
export const en = {
	...
	JANDA_provide_free_homepage_for_guest: 'We provide free homepage for customers.',
	JAPANESE: 'Japanese',
	KOREAN: 'Korean',
	MALE: 'M',
	FEMALE: 'F',
	...
	appliedby_default_in_periods_with_no_price_set: 'Applied by default in periods with no price',
	applies_to_all_reservations_booked_together: 'Applies to all reservations booked together',
	apply: 'apply',
	...
	are_you_sure_you_want_to_delete_the_reservation: 'Are you sure you want to delete the reservation?',
	are_you_sure_you_want_to_delete_this_guest: 'Are you sure you want to delete this guest?',
	...
	basic_price_is_used_when_season_is_un_setted: 'Use base price during off-season periods.',
	...
	consent_to_collection_of_personal_information: 'Consent to Collect Personal Information',
	contact: 'contact',
	...
	displays_a_new_reservation_within_the_set_time: 'Display new reservations within the set time.',
	division: 'division',
	do_copy: 'duplicate',
	do_create: 'create',
	do_delete: 'delete',
	...
	do_you_want_request_making_homepage: 'Are you sure you want to create a homepage?',
	domitory: 'dormitory',
	dont_send: 'unsent',
	download: 'download',
	eamil: 'email',
	...
	must_input_text_of_every_lang_you_supporting: 'You must fill in all languages ​​you support.',
	name: 'name',
	...
	others_booked_by_the_reservation_will_not_be_erased: 'Other people booked by this reservation will not be erased.',
	outgoing_destination: 'From',
	page: 'page',
	page_does_not_exist: 'Page does not exist',
	password: 'password',
	password_condition: '* 1 or more special characters, 7 to 15 alphanumeric characters',
	...
	product1_detail4: 'Most services are available and not available after 2 weeks.',
	product1_detail5: 'If you apply a new product after the deadline, you can continue to use it.',
	product1_short1: 'Can try it for 2 weeks',
	product1_short2: 'Try and decide',
	product1_short3: 'You can start right now',
	product2_detail1: 'Optimized for guest house and small to medium-sized accommodations.',
	product2_detail3: 'You can get a free homepage on the couch.',
	product2_detail4: 'The expiration date is one month, with a repayment after one month.',
	...
	product3_detail4: 'You can request a customed homepage which may be charged extra cost.',
	product3_detail5: 'The expiration date is for one month, with a repayment after one month.',
	...
	remove_all_reservations_booked_together: 'remove all reservations booked together',
	...
	room_name: 'room name',
	room_name_must_be_10_characters_or_less: 'Room name must be under 10 letters.',
	...
	the_max_count_of_houseName_is_20: 'Your name can be up to 20 characters long.',
	the_memo_gives_an_alarm_on_the_next_connection: 'The memo gives an alarm on the next connection.',
	...
	update_to_recommended_browser_chrome: 'Update to recommended browser (Chrome)',
	upgrade: 'upgrade',
	...
	we_will_contect_you_in_3_days: 'A representative will contact you within 3 days.',
	wed: 'WED',
	...
	will_only_use_the_reservation_system: 'I will only use the reservation system',
	...
	your_request_cannot_be_fulfilled_right_now: "I can't fulfill my request right now",
	...
	F_have_x_days_left_to_try_for_free: (daysLeftToExpire: string) => `$ {DaysLeftToExpire} left until service terminated`,
	F_user_name_hello: (userName: any) => `Hello $ {userName}`,
	F_user_name_good_luck: (userName: any) => `$ {userName} wish you all the best.`,
	F_user_name_have_a_bright_day: (userName: any) => `$ {userName}, have a great day today`,
	...
	F_product2_detail2: (n: any) => `This product is suitable for accommodation with $ {n} rooms or less.`,
	F_product3_detail2: (n: any) => `This product is suitable for accommodation with $ {n} rooms or less.`,
	...
	HM_provides_guests_with_a_comfortable_and_convenient_accommodation_send_the_guide_page: (
		<span>
			The House Manual provides a guide page for guests to use the accommodation easily and conveniently. Send. <br />
			The house manual will save you the trouble of explaining how to use your accommodation.
		</span>
	),
	...
	additionaly_setting_to_will_good_for_manage_ment: (
		<span>
			In addition, the following settings will help you to run the <Mbr /> accommodation!
		</span>
	),
	...
	price_priority: '* Priority: Room type base price < Seasonal base price < Season day price < Daily price',
	...
	completing_this_card_registration_you_agree_to_the: 'By registering this card information, you agree to the following',
	...
	card_regist_complete_message: (
		<span>
			The card information is registered. You can check the information in <TextButton color="primary">MYPage</TextButton>
		</span>
	),
	...
	JANDA_home_desc: "You can check the assignment status for today's date in the current dashboard.",
	bookingList__desc: 'The reservation information is displayed in chronological order.',
	price_setting__desc:
	...
	HM_set__desc: (
		<span>
			The AI Auto Solution provides a guide page for guests to use the accommodation easily and conveniently. Send. <br />
			The AI Auto Solution will save you the trouble of explaining how to use your accommodation.
		</span>
	),
	user_info: 'Profile',
	...
	how_to_save_sms_template_doc: (
		<JDlist
			...
			contents={[
				...
				<div>
					2. Enter the title and message on the form creation screen, and select the middle of the message screen. Generate
					in the middle
					<b>
						Accommodation Date / Accommodation Information / Reservation Name / Price / Payment Method / Payment Status / AI
						Auto URL
					</b>
					Click on the message below in the <b> Form Message </b> to send the message. The information is entered
					automatically.
				</div>,
				<div>
					<PhotoFrame
				...
				<div>
					...
					<b>
						{' '}
						cancellation of reservation / creation of reservation / creation of reservation (unpaid) / reservation update{' '}
					</b>
					Select and set
				</div>,
				<div>
					4. Specify the destination for each <b> guest / host / guest + host </b>. You can always turn on / oFF{' '}
					<b> automatically active </b> on the right Your notification text will be sent to the customer
				</div>
			]}
		/>
	),
	...
	how_to_send_sms_for_all_doc: (
		<JDlist
			...
			contents={[
				<span>
					1. Group SMS is available on the solution main screen and reservation list screen. In the <b> Main Screen </b>, you
					can see at the top of today's reservation list {''}
					Click the <b> ‘Group Messages’ </b> button to send. {''}
					On the <b> Reservation List </b> screen, select the scheduler you want Click the <b> 'Send Text' </b> button at the
					top to send a group text to You can send
				</span>,
				<div>
					2. However, if you want to send a group SMS, make it in advance on the <b> SMS Form </b> screen. You must have an
					SMS form. Create a unique and fun SMS form. Emergency evacuation letter example: Breakfast reminder letter, dinner
					party event guide letter, Construction information, lost property information,
				</div>
			]}
		/>
	),
	...
	add_card_dec: 'Please add your card infomation for express and convenient service',
	...
	mypage_desc: 'You can manage your subscriptions and view the accommodations and user profiles you have created.',
	room_config_desc: 'Create and edit room types and rooms to run your accommodation.',
	HouseStatus: {
		DISALBE: 'DISABLED',
		WAIT: 'WAIT',
		ENABLE: 'ENABLE'
	...
	periodical_payment_is_stopped: (houseName: string) => `${houseName}'s periodical pay is stopped`,
	...
	please_check_file_has_special_char: 'Check for special characters in the file.',
	...
	sms__decs: 'If you set up an SMS form, you can conveniently send the form when you send a message.',
	do_you_want_to_change_periodical_pay: 'Periodic payments are currently taking. Do you want to change it?',
	...
	refund: 'Refund',
	do_you_really_want_to_cancel_our_service: 'Do you really cancel your subscription?',
	if_you_cancel_service_please_notice_below_things: (
		<span>
			If you cancel your subscription, you will no longer be able to use the service after your subscription expires. It is
			not available. <br />
			Note the following
		</span>
	),
	...
	service_termination_warn3: 'It is impossible to change or modify an existing reservation.',
	...
	homepage_request_desc: 'You can open a homepage for free. We provide a customizable homepage.',
	breakfast: 'Breakfast',
	...
	dollor1_will_be_refund_immediatly: 'One dollar will be refunded immediately after payment.',
	pay_regist_pay_notice1: 'If you do not want to use the service, you must cancel your subscription within 14 days.',
...
If you change the current status on the [My Page> Periodic Payment Management] page, the regular payment will not be paid.`,
	...
	createHouse_desc: (
		<span>
			...
			<span className="JDtextColor--error">* Please note that monthly charges are paid separately per house. </span>
		</span>
	),
	solution_usage_guide_desc: 'We will guide you how to use Janda booking system.',
	...
	product_type_help_txt: () => (
		<span>
			More than 20 rooms are JANDA-H (110,000 / month) <br /> Other JANDA-G (55,000 / month) recommended
		</span>
	),
