...
export const kr = {
         ...
         capacity: "수용인원",
         capacity_must_be_at_least_1_person:
           "수용인원은 1명 이상이여야 합니다.",
         caution: "주의",
         ...
         the_phone_number_set_is_not_valid:
           "설정된 전화번호가 유효하지 않습니다.",
         there_is_an_alarm_set_note: "알람 설정된 메모가 있습니다.",
         there_is_no_room_in_selected_date:
           "해당날짜에 예약가능한 방이 없습니다",
         ...
         this_is_an_old_browser_Problems_may_occur_while_using_the_service_Please_update_your_browser: (
           <span>
             오래된 브라우저 입니다. 서비스 이용중 문제가 발생할수 있습니다.{" "}
             <br /> 브라우저를 업데이트 해주세요.
           </span>
         ),
         ...
         additionaly_setting_to_will_good_for_manage_ment: (
           <span>
             추가로 다음과 같은 설정을 해두시면 <Mbr /> 숙소운영에 도움이
             될거에요!
           </span>
         ),
         ...
         guest_memo: "게스트 메모",
         write: "작성",
         no_guest_notes_after_today:
           "오늘자 이후로 작성된 게스트 메모가 없습니다.",
         update: "업데이트",
         create: "생성하기",
         ...
         card_regist_complete_message: (
           <span>
             카드 정보가 등록 되었습니다.
             <TextButton color="primary">MYPage</TextButton> 에서 그 내용을
             확인하실수 있습니다"
           </span>
         ),
         ...
         HM_set__desc: (
           <span>
             하우스 메뉴얼은 게스트가 쉽고 편하게 숙소를 이용할 수 있도록 안내
             페이지를 송신합니다. <br />
         ...
         how_to_save_sms_template_doc: (
           <JDlist
             ...
             contents={[
               ...
               <div>
                 3. 자동발신 상태를{" "}
                 <b>예약취소시/예약생성시/예약생성시(미결제)/예약업데이트시</b>{" "}
                 별로 선택하여 설정하고
               </div>,
               <div>
                 4. 발신대상을 <b>게스트/호스트/게스트+호스트</b> 별로 지정을
                 해주시고 우측에 <b>자동발신 활설화</b> 여부를 on / oFF
           ...
           <JDlist
             ...
             contents={[
               <span>
                 ...
                 <b>‘단체메시지’</b> 버튼을 클릭하셔야 보낼 수 있고,{" "}
                 <b>예약목록</b> 화면에서는 내가 원하는 예약자를 선택하여 리스트
                 상단에 <b>‘문자전송’</b>버튼을 클릭해서 여러명에게 단체문자를
                 보낼 수 있습니다.
               </span>,
               <div>
                 2. 그러나 단체SMS를 보내기 위해서는 <b>SMS양식</b>화면에서 미리
                 만들어 둔 SMS양식이 있어야 합니다. 개성있고 재밌는 SMS양식을
                 만들어주세요. 예시 : 조식알림문자, 저녁 파티이벤트 안내 문자,
                 공사안내, 분실물안내, 긴급대피안내문자
               </div>
             ]}
           />
