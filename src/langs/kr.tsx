	...
	how_to_save_sms_template_doc: (
		<JDlist
			...
			contents={[
				...
				<div>
					4. 발신대상을 <b>게스트/호스트/게스트+호스트</b> 별로 지정을 해주시고 우측에 <b>자동발신 활설화</b> 여부를 on / oFF 설정해주시면 언제든지 고객에게 알림 문자가 발송되게
					설정됩니다
				</div>
			]}
		/>
	...
	how_to_send_sms_for_all_doc: (
		<JDlist
			...
			contents={[
				...
				<div>
					2. 그러나 단체SMS를 보내기 위해서는 <b>SMS양식</b>화면에서 미리 만들어 둔 SMS양식이 있어야 합니다. 개성있고 재밌는 SMS양식을 만들어주세요. 예시 : 조식알림문자, 저녁 파티이벤트
					안내 문자, 공사안내, 분실물안내, 긴급대피안내문자
				</div>
			]}
		/>
	),
