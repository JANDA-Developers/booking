...
import { bookingModalGetStartBookingVariables, bookingModalValidate } from "./helper";
import { LANG } from "../../hooks/hook";
import { muResult, toNumber } from "../../utils/utils";
import { AutoSendWhen } from "../../types/enum";

export const getHandler = (bookingModalContext: IBookingModalContext, smsModalInfoTemp: any) => {
    const { deleteBookingMu, memoHook,
        paymentStatusHook, bookingNameHook,
        priceHook, bookingPhoneHook, checkInOutHook,
        bookingStatusHook, payMethodHook, breakfast,
        refundFn, startBookingMu, bookingModalHook,
        refundAmt, sendSmsModalHook, bookingData, totalPrice,
        updateBookingMu, confirmModalHook, funnelStatusHook } = bookingModalContext
    ...
    return { handleRefundBtn, deleteModalCallBackFn, startBooking, handleUpdateBtnClick, handleCreateBtnClick, handleDeletBtnClick }
}