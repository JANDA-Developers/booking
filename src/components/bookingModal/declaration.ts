import { BookingModalMode, GB_booking, IGuestCount, IRoomType } from '../../types/interface';
import {
...
import { Gender, PricingType, BookingStatus, PaymentStatus, PayMethod } from '../../types/enum';
import { IUseSelect, IUseDayPicker, TUseInput, IUseModal } from '../../hooks/hook';
import { IContext } from '../../pages/bookingHost/BookingHostRouter';
import { IModalSMSinfo } from '../smsModal/SendSmsModal';
import { MutationFn } from 'react-apollo';
import { IMu, ISet } from '@janda-com/front/build/types/interface';
...
export interface IRoomSelectInfo {
	...
	pricingType: PricingType;
	roomNames?: string[];
	options?: getHouse_GetHouse_house_roomTypes_optionalItems[];
}
...
export interface IBookingModalContext {
	...
	setOptional: ISet<RoomTypeOptionalItemSubmitInput[]>;
...
export interface IBookingModalProp {
	...
	updateBookingCallBack?: (result: 'error' | updateBooking_UpdateBooking) => any;
	deleteBookingCallBack?: (result: 'error' | deleteBooking_DeleteBooking) => any;
	bookingId?: string;
