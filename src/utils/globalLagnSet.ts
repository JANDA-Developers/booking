...
export const globalLanguageSetting = () => {
  ...
  const settings = [
    ...
    { value: PAYMETHOD_FOR_BOOKER_OP, enumKey: "PayMethod" },
    { value: OPTIONAL_APPLY_PAYMETHOD, enumKey: "PayMethod" },
    { value: PAYMETHOD_FOR_HOST_OP, enumKey: "PayMethod" },
    { value: PAYMETHOD_FOR_JD_OP, enumKey: "PayMethod" },
    GET_SMS_TARGET_OP,
    PRICING_TYPE_OP,
