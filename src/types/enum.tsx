...
export type TMarginSize = 'no' | 'largest' | 'huge' | 'large' | 'normal' | 'small' | 'tiny' | 'superTiny';
export type TextAlign = 'left' | 'right' | 'center';
export type TextSize = 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'normal' | 'small' | 'tiny' | 'superTiny';
...
export type IconSize = 'tiny' | 'small' | 'normal' | 'large' | 'huge' | 'largest' | 'largest2';
