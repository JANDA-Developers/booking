import {
	...
	getAllRoomTypeForBooker_GetAllRoomTypeForBooker_roomTypes_optionalItems
} from './api';
...
export interface IRoomTypeOptional extends getAllRoomTypeForBooker_GetAllRoomTypeForBooker_roomTypes_optionalItems {}
...
export interface IPayHistroy extends getPayHistory_GetPayHistory_result_payHistories {}
export interface IHouseConfig extends getMyProfile_GetMyProfile_user_houses_houseConfig {}
...
export interface IBlockOp extends getGuests_GetGuests_guests_GuestRoom_blockOption {}
...
export type TBookingModalOpenWithMark = (bookingModalProp: IBookingModalProp) => void;
